            ...
            <div className='flex justify-center items-center'>
                <ul className='space-y-4'>
                    <li className='flex items-center'>
                        ...
                        <p className='text-xl'>+923444750526</p>
                    </li>
                    <li className='flex items-center'>
                        <Image src={mail} alt="mail" className='h-[110px] w-auto mr-6' />
                        <p className='text-xl'>4750526@gmail.com</p>
                    </li>
                </ul>
            </div>
            <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
                <h2 className='text-5xl font-bold text-orange-400 mb-4'>Let's Connect</h2>
                <p className='text-white70 mb-6'>Send me a message and lets schedule a call!</p>
                <form className='space-y-4' action="https://getform.io/f/bpjmqylb" method="POST">
                    <div className='grid grid-cols-2 gap-4'>
                        ...
                        <input type="text" name="Last Name" className='bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' placeholder='Last Name' />
                    ...
                    <button className='bg-orange-700 hover:bg-orange-500 text-white px-6 py-2 w-full font-semibold rounded-xl text-xl'>Send Message</button>
                </form>
            </div>
        </div>
    )
